...
const markup = (title: string, pubDate: string): SatoriNode =>
...
export async function GET(context: APIContext) {
	...
	// Ensure we have a fresh Uint8Array whose buffer is a plain ArrayBuffer (not SharedArrayBuffer)
	const bytes = new Uint8Array(png);
	const arrayBuffer = bytes.buffer; // typed as ArrayBuffer
